...
path_magpie <- "/p/projects/piam/SDP_runs/SDP_final_rerun/magpie/"
...
path_settings_coupled <- paste0(path_remind,"config/scenario_config_coupled_SDPfinal.csv")
path_settings_remind  <- paste0(path_remind,"config/scenario_config_SDPfinal.csv")
